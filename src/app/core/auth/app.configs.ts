...
export type localStorageName=any;
export type CollegeLogo=any;
...
export const appConfig: AppConfig = {
    ...
    localStorageName:{
        TenantInfoStorageName:"tenant_info"
    },
    CollegeLogo:{
        collegeLogo:"assets/images/logo/logo.png"
    },
    Title:{
        Title:"AdrPlexus"
    }
...
export const SitePreference = {
    ...
    PAGE: {
      GridRowViewCount: 5,
      GridRowViewPageSizeOptions: [5, 10, 50, 100,1000,5000]
    }
